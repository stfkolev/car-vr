'use strict';
var camera_1 = require('./18');
var binocs_1 = require('./17');
var CarBody_1 = require('./22');
var CarProps_1 = require('./1');
var grid_1 = require('./26');
var Utils = require('./0');
var Model = function () {
  function Model(_main) {
    ...
    this.renderer.setClearColor(3749171);
  ...
  Model.prototype.introPreloading = function () {
    ...
    TweenLite.to(this.cam, 1, { distTarget: 30 });
  ...
  Model.prototype.introStart = function () {
    ...
    TweenLite.to(this.spotLight, 3, { intensity: 1 });
    TweenLite.to(this.props, 3, { speed: 12 });
  };
  Model.prototype.addSceneLights = function () {
    this.ambLight = new THREE.AmbientLight(16777215, 0.2);
    this.spotLight = new THREE.DirectionalLight(16777215, 0);
