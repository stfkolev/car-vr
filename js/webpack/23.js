'use strict';
var headgridVS = require('./6');
var headgridFS = require('./5');
var tailLightVS = require('./10');
var tailGridVS = require('./8');
var tailGridFS = require('./9');
var flareVS = require('./4');
var flareFS = require('./3');
var turnBarVS = require('./12');
var stopBarVS = require('./7');
var turnBarFS = require('./11');
var CarLights = function () {
  ...
  CarLights.prototype.initStopFlares = function () {
    var glowStopMat = new THREE.ShaderMaterial({
      uniforms: { texture: { value: this.glowStopText } },
