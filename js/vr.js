...
([
    ...
    (function (module, exports, __webpack_require__) {
        ...
        var Automotive = /** @class */ (function () {
            ...
            Automotive.Width = 2.283; // Car width
            Automotive.WheelTrack = 1.72; // Wheel track
                ...
                var _loop_1 = function (i) {
                    ...
                    switch (this_1.manifesto[i].type) {
                        ...
                        case "cubetexture":
                            ...
                            this_1.loaderCube.load(["xp" + ext, "xn" + ext, "yp" + ext, "yn" + ext, "zp" + ext, "zn" + ext], function (_obj) {
                                this.assetAquired(_obj, this.manifesto[i].name);
                            }.bind(this_1), undefined, function (_err) {
                                this.assetFailed(_err, this.manifesto[i].name);
                            }.bind(this_1));
    ...
    (function (module, exports, __webpack_require__) {
        ...
        var Model = /** @class */ (function () {
            ...
            Model.prototype.introPreloading = function () {
                ...
                TweenLite.to(this.cam, 1.0, {
                    distTarget: 30
                });
                TweenLite.to(this.cam.rotTarget, 1.0, {
                    x: 0,
                    y: 90
                });
            };
            ...
            Model.prototype.introStart = function () {
                ...
                TweenLite.to(this.spotLight, 3.0, {
                    intensity: 1.0
                });
                TweenLite.to(this.props, 3.0, {
                    speed: 12.0
                });
            };
